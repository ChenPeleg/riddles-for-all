    ...
    <div className="min-h-screen bg-surface-50">
      <div className="max-w-5xl mx-auto px-6 py-12">
        <header className="mb-12 animate-fade-in">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-surface-900 tracking-tight mb-4">Discover <span className="text-brand-accent">Sources</span></h1>
          <p className="text-surface-600">Browse the unique collections that power our riddles.</p>
        </header>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 animate-fade-in [animation-delay:100ms]">
          {sources.map(source => (
            ...
            >
              ...
              <div className="font-bold text-lg leading-tight line-clamp-2">{source}</div>
            </button>
          ))}
        </div>
        ...
        {selectedSource ? (
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-8">
               <div className="flex items-center gap-4">
                  ...
                  <h2 className="text-2xl font-bold text-surface-900 tracking-tight">{selectedSource}</h2>
               </div>
          ...
          <div className="text-center py-24 bg-white rounded-[2.5rem] border-2 border-dashed border-surface-200 animate-fade-in [animation-delay:200ms]">
            ...
            <p className="text-surface-400 text-lg font-medium">Select a book above to explore its contents.</p>
          </div>
        )}
      </div>
    </div>

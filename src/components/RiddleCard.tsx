    ...
    return (<div dir={isRTL ? 'rtl' : 'ltr'}
            ...
            <div className="relative">
                {!showSolution ? (<button
                    ...
                    >
            <span
                className="absolute inset-0 flex items-center justify-center w-full h-full text-white bg-brand-primary opacity-0 transition-opacity duration-300 ease-in-out motion-reduce:transition-none group-hover:opacity-100">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path
                  ...
                  d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                        ...
                        <span
                            className="absolute flex items-center justify-center w-full h-full text-brand-primary opacity-100 transition-opacity duration-300 ease-in-out motion-reduce:transition-none group-hover:opacity-0">{t('riddle.reveal_solution')}</span>

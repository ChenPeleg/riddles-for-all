...
export const translations: Record<Lang, Record<string, any>> = {
  en: {
    ...
    riddle: {
      ...
      mark_done: "Mark as solved",
      mark_not_done: "Mark as not solved",
      difficulties: {
        easy: "Easy",
        medium: "Medium",
        hard: "Hard",
    ...
    word_collection: {
      ...
      description:
        "Manage your collection of words and terms used in searches and tagging.",
      add_word: "Add word",
    ...
    books: {
      gym_for_the_brain: "Gym for the Brain - 300 Riddles",
      riddle_me_this:
  ...
  he: {
    ...
    riddle: {
      ...
      mark_done: "סמן כפתרתי",
      mark_not_done: "הסר סימון פתרתי",
      difficulties: {
        easy: "קל",
        medium: "בינוני",
        hard: "קשה",
    ...
    books: {
      gym_for_the_brain: "חדר כושר למוח - 300 חידות",

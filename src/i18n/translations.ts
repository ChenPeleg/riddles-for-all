...
export const translations: Record<Lang, Record<string, any>> = {
  en: {
    ...
    book: {
      ...
      bookmark_limit_reached: "Maximum 5 bookmarks per book",
      no_bookmarks: "No bookmarks yet",
      go_to_bookmark: "Go to bookmark",
      page: "Page",
      track_reading: "Track reading progress",
      tracking_enabled: "Tracking enabled - Click to disable",
      tracking_disabled: "Reading tracking disabled",
      resume_reading: "Resume from last page",
      resume_offer: "You were on page {page}. Want to resume?",
      resume_button: "Resume",
      dismiss_button: "Dismiss",
      enable_tracking_aria: "Enable reading progress tracking",
      disable_tracking_aria: "Disable reading progress tracking",
    },
    categories: {
  ...
  he: {
    common: {
      ...
      description:
        "אימון המוח באמצעות אוסף נבחר של חידות ותעלומות. מאתגר את המחשבה, חידה אחרי חידה.",
    ...
    book: {
      ...
      next: "הבא",
      bookmarks: "סימניות",
      add_bookmark: "הוסף סימנייה",
      remove_bookmark: "הסר סימנייה",
      bookmark_added: "סימנייה נוספה",
      bookmark_removed: "סימנייה הוסרה",
      bookmark_limit_reached: "מקסימום 5 סימניות לספר",
      no_bookmarks: "אין סימניות עדיין",
      go_to_bookmark: "עבור לסימנייה",
      page: "עמוד",
      track_reading: "עקוב אחר התקדמות קריאה",
      tracking_enabled: "מעקב מופעל - לחץ לכיבוי",
      tracking_disabled: "מעקב קריאה כבוי",
      resume_reading: "המשך מהעמוד האחרון",
      resume_offer: "היית בעמוד {page}. רוצה להמשיך?",
      resume_button: "המשך",
      dismiss_button: "התעלם",
      enable_tracking_aria: "הפעל מעקב התקדמות קריאה",
      disable_tracking_aria: "כבה מעקב התקדמות קריאה",
    },
    categories: {
